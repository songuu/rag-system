...
- LangChain / LangGraph: `@langchain/core@1.1.48`, `@langchain/langgraph@1.3.2`, `@langchain/openai@1.4.7`
...
## Removed Unused Integration Bundle

The deprecated community integration bundle and its unused browser-automation subtree were later
removed after a source scan confirmed that the application had no imports from them. No replacement
package was required.

## Verification

- `pnpm outdated --format json` - no newer direct dependency versions remained at validation time.
